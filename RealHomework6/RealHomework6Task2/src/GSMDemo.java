...
//		two.removeSimCard();
		...
		System.out.println("Lets make some calls: ");
		one.call(two, 130);
		two.call(one, 25);
		one.call(two, 14);
		System.out.println();
		
		System.out.println("Last calls for GSM one: ");
		one.printInfoForTheLastIncomingCall();
		System.out.println();
		one.printInfoForTheLastOutgoingCall();
		System.out.println();
		
		System.out.println("Last calls for GSM two: ");
		...
		System.out.println("Amount of money that two needs to pay: "); // 
		two.getSumForCall();
		System.out.println();
		
		System.out.println("Total outging calls duration in minutes for one: ");
		System.out.println(one.outgoingCallsDuration);
		System.out.println();
		
		System.out.println("Total outging calls duration in minutes for two: ");
